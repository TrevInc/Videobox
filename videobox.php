...
class plgSystemVideobox extends JPlugin
{
	...
	public function onAfterDispatch(){
		...
		if(($app->isSite())&&(method_exists($document, 'addCustomTag'))){
			...
			$document->addCustomTag('</script><script type="text/javascript" src="'.JURI::root().'/plugins/system/videobox/html5media.min.js"></script><script type="text/javascript" src="'.JURI::root().'/plugins/system/videobox/videobox.js"></script><script type="text/javascript">
				var displayvideo;
